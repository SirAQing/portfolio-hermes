...
const translations = {
  en: {
    ...
    'hero.title.1': 'AI Builder Engineer',
    ...
    'hero.badge.builder': 'AI Builder Engineer',
    ...
    'proj.portfolio.title': 'Hermes Portfolio & AI Assistant',
    'proj.portfolio.desc': 'A personal brand website named Hermes built with FastAPI + React, featuring bilingual support, knowledge base CMS, and floating AI chat assistant. AI chat messages sync in real-time to Feishu & WeChat, with scheduled daily summaries. Live at liumingqing.com, open source on GitHub.',
    ...
    'proj.portfolio.background': 'Traditional resumes and portfolios offer weak static display and struggle to demonstrate AI capabilities and content depth. Designed and developed Hermes, a personal website integrating AI assistant, knowledge base CMS, and bilingual display to enhance online presence and communication efficiency.',
    'proj.portfolio.work': 'Built Hermes frontend with React + TypeScript + Vite, supporting responsive layout and bilingual switching; Designed a knowledge base CMS with Markdown + manifest article management, tree-nav TOC, scroll positioning, and reading progress; Developed a floating AI assistant with quick actions, conversation context, and SSE streaming replies; Implemented Hermes backend with FastAPI for session management, message persistence, streaming output, and integrations with DeepSeek and Ollama models; Deployed with Docker Compose, bound custom domain.',
    'proj.portfolio.results': 'Consolidated resume, projects, technical articles, and AI capabilities into a unified Hermes online presence; Completed the closed loop: portfolio display + AI interaction + knowledge content + real-time notifications + scheduled summaries; Accumulated full-stack practice spanning React frontend, FastAPI backend, LLM integration, and SSE streaming.',
  ...
  zh: {
    ...
    'proj.portfolio.title': 'Hermes 个人官网与 AI 访客助手',
    'proj.portfolio.desc': '基于 FastAPI + React 打造的个人品牌官网 Hermes，支持中英双语、知识库 CMS、浮动 AI 聊天助手。AI 对话实时同步飞书与微信，每日定时汇总推送。已上线 liumingqing.com，GitHub 开源。',
    ...
    'proj.portfolio.background': '针对传统简历与作品集静态展示能力弱、难以体现 AI 能力与内容沉淀深度的问题，自主设计并开发 Hermes 个人官网，集成 AI 助手、知识库文章系统和中英双语展示，提升在线展示与沟通效率。',
    'proj.portfolio.work': '基于 React + TypeScript + Vite 完成 Hermes 前端开发，支持响应式布局与中英双语切换；设计知识库内容系统，基于 Markdown + manifest 管理文章，支持目录树导航、滚动定位与阅读进度；开发浮动 AI 访客助手组件，支持快捷提问、对话上下文维护与 SSE 流式回复；基于 FastAPI 实现 Hermes 后端，完成会话管理、消息存储、流式输出，并支持 DeepSeek 与 Ollama 等模型接入；基于 Docker Compose 完成前后端一体化部署，上线并绑定独立域名。',
    'proj.portfolio.results': '将个人简历、项目作品、技术文章和 AI 能力整合为统一的 Hermes 线上入口；完成"官网展示 + AI 交互 + 知识内容沉淀 + 实时通知 + 定时汇总"闭环设计；沉淀 React 前端、FastAPI 后端、LLM 接入与 SSE 流式交互的一体化全栈实践。',
